...
#Se extraeran los datos del usuario
tweetsMyAccount = get_timeline(user = "@elonmusk", n = 3500, lang="es", 
                               include_rts = T)
